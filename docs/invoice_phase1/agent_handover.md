...
3. `docs/invoice_phase1/service_gap_analysis.md`
4. `docs/invoice_phase1/contracts/*.schema.json`
5. `examples/n8n/invoice_phase1_node_plan.md`
...
- Run C01-C08 against both canonical invoices.
...
- structured and PDF fixtures converge before C03-C08.
